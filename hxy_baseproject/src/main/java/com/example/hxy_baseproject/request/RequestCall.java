...
public class RequestCall {
    ...
    public Call buildCall(MyCallBack callback) {
    ...
    private Request generateRequest(MyCallBack callback) {
        return okHttpRequest.generateRequest(callback);
    }

    public void execute(MyCallBackImpl callback) {
        buildCall(callback);

        if (callback != null) {
            callback.beforeRequest(getOkHttpRequest().getId());
        }
